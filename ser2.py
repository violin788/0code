...
def ser2():
    ...
    def process(): 
        ...
        dictionary = {"data":to_be_returned}
        to_be_returned2 = json.dumps(dictionary)
        #y = json.dumps(x)


        #to_be_returned2 - {"data":to_be_returned}
        return to_be_returned
        #return JSON.stringify(to_be_returned)
        #return json.dumps(to_be_returned)
